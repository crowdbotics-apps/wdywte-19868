"""wdywte_19868 URL Configuration
...
admin.site.site_header = "WDYWTE"
admin.site.site_title = "WDYWTE Admin Portal"
admin.site.index_title = "WDYWTE Admin"

# swagger
api_info = openapi.Info(
    title="WDYWTE API",
    default_version="v1",
    description="API documentation for WDYWTE App",
)
